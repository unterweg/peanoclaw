...
peanoclaw::records::VertexDescriptionPacked peanoclaw::records::VertexDescription::convert() const{
   ...
   void peanoclaw::records::VertexDescription::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, int communicateSleep) {
   ...
   void peanoclaw::records::VertexDescription::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, int communicateSleep) {
      if (communicateSleep<0) {
...
peanoclaw::records::VertexDescription peanoclaw::records::VertexDescriptionPacked::convert() const{
   ...
   void peanoclaw::records::VertexDescriptionPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, int communicateSleep) {
      if (communicateSleep<0) {
   ...
   void peanoclaw::records::VertexDescriptionPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, int communicateSleep) {
      if (communicateSleep<0) {
